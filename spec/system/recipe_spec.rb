...
RSpec.describe 'Recipe', type: :system do
  ...
  subject do
    Recipe.new(name: 'Maple Cupcakes', preparation_time: '20 min', cooking_time: '15 min', description: 'Preheat the oven to 350 degrees F (175 degrees C). Grease two 12-cup muffin tins.', user_id: user.id)
  end
  before { subject.save }
